		...
		if (mysqli_num_rows($query) > 0) {
			...
			<form method="post" action="login_form.php">
				...
				<tfoot>
					...
					<tr>
						<td><a href="store.php" class="btn btn-info"><i class="fa fa-angle-left"></i> Continue Shopping</a></td>
				...
				if (!isset($_SESSION["uid"])) {
					echo '
							...
							<a href="" data-toggle="modal" data-target="#Modal_register" class="btn btn-primary">Checkout Now</a></td>
								</tr>
							</tfoot>
						...
						<form action="checkout.php" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/myfiles/public_html/payment_success.php"/>
									...
									<input type="submit" id="submit" name="login_user_with_product" name="submit" class="btn btn-primary" value="Checkout Now">
									</form></td>
